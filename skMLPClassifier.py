...
"""
Implementation of MLP neural network to predict brain hemorrhaging for stroke patients
"""
...
# Accuracy:
# Identity: 81%, Logistic: 95%, Tanh: 94.5%, Relu: 93%

for a in ['identity', 'logistic', 'tanh', 'relu']:
	model = MLPClassifier(activation=a)
