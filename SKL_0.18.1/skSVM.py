"""
Implementation of SVM (support vector machine) to predict brain hemorrhaging for stroke patients
"""
...
# use linear, rbf (radial basis function), polynomial, and sigmoid kernels
# accuracy: linear: 85%, rbf 89%, polynomial 82%, sigmoid 59%
for kernel in ['linear', 'rbf', 'poly', 'sigmoid']:
	...
	print("Final results for kernel '%s': testing accuracy of %f%%"%(kernel, testAccuracy * 100))
